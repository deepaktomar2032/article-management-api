...
export const underscoreToCamelCase = (str: string): string => str.replace(/_([a-z])/g, (match, letter) => letter.toUpperCase())

export const camelCaseToUnderscore = (str: string): string => str.replace(/([a-z])([A-Z])/g, '$1_$2').toLowerCase()
